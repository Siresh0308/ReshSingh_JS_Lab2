...
let questions = [
    ...
    new Question(
        "Which of the following gymnosperms yields medicine for asthma?",
        ["Ephedra", "Typha", "Pinus", "Cycas"],
        "Ephedra"
    )
];
...
function showScores() {
    ...
    gameOverHTML += `<h2 id='score'> Your Scores: ${quiz.score + "/" + questions.length
